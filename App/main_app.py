...
responses = {
    ...
    "What is my account balance": ["Your account balance is $5014.35."],
    "Make payment":["Please provide the payment method - Debit Card, Credit Card or ACH"],
    "Debit Card":["Please provide the Debit Card number"],
    "dcno": ["Please provide the expiration date"],
    "exp": ["Please provide the CVV"],
    "cvv": ["Please provide the service provider - PG&E, Comcast or AT&T"],
    "PG&E": ["Enter the amount to pay"],
    "fif": ["Payment successful. Your account balance is now $4964.35."],
    "hund": ["Payment failed, check again later."],

    "Make payment": ["We’re here to help you with your payment. Could you let us know your preferred payment method: Debit Card, Credit Card, or ACH?"],
    "Debit Card": ["Got it! Please share your Debit Card number so we can proceed."],
    "dcno": ["Thank you! Could you provide the card's expiration date?"],
    "exp": ["Almost done! Please share the CVV for secure processing."],
    "cvv": ["Thank you for providing the details. Could you let us know the service provider: PG&E, Comcast, or AT&T?"],
    "PG&E": ["Great! Please enter the amount you’d like to pay."],
    "fif": ["Payment successful! Thank you for your payment. Your updated account balance is $4964.35."],
    "hund": ["Uh oh.. there seems to be an issue with the payment, don’t worry we have your money safe. Please check back again after an hour."],
...
def start_chat():
    st.write(
        "\nChatbot: Hello, I am your Bank's Financial ChatBot. Feel free to ask me to perform any tasks or provide help with your queries:"
    )
